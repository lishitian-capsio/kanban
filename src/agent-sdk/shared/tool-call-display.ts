export interface KanbanToolCallDisplay {
	toolName: string;
 ...
 */
function resolveKanbanCommandDisplay(command: string): KanbanToolCallDisplay | null {
 ...
 */
function resolveKanbanRunCommandDisplay(input: unknown): KanbanToolCallDisplay | null {
	if (!isRecord(input)) {
		return null;
	}
...
export function getKanbanToolCallDisplay(toolName: string | null | undefined, input: unknown): KanbanToolCallDisplay {
...
export function formatKanbanToolCallLabel(
