// Builds the view model for the native Kanban chat panel.
...
interface UseKanbanChatPanelControllerInput {
	taskId: string;
...
interface UseKanbanChatPanelControllerResult {
	draft: string;
...
export function useKanbanChatPanelController({
	taskId,
	summary,
