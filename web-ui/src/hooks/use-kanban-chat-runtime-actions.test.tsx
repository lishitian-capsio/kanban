...
interface HookSnapshot {
	sendTaskChatMessage: ReturnType<typeof useKanbanChatRuntimeActions>["sendTaskChatMessage"];
	loadTaskChatMessages: ReturnType<typeof useKanbanChatRuntimeActions>["loadTaskChatMessages"];
	abortTaskChatTurn: ReturnType<typeof useKanbanChatRuntimeActions>["abortTaskChatTurn"];
	cancelTaskChatTurn: ReturnType<typeof useKanbanChatRuntimeActions>["cancelTaskChatTurn"];
}
...
function HookHarness({
	...
	const state = useKanbanChatRuntimeActions({
		currentProjectId,
		onSessionSummary,
	});
...
describe("useKanbanChatRuntimeActions", () => {
