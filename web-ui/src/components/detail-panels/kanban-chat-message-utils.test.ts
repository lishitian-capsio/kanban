import { getKanbanToolCallDisplay } from "@runtime-kanban-tool-call-display";
...
describe("getToolSummary", () => {
	it("parses structured tool calls through the shared runtime helper", () => {
		expect(
			getKanbanToolCallDisplay("fetch_web_content", {
...
describe("kanban command display", () => {
	...
	it("works with getKanbanToolCallDisplay directly for kanban commands", () => {
		const display = getKanbanToolCallDisplay("run_commands", {
